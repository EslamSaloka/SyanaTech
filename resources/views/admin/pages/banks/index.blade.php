...
<div style=" margin-bottom: 14px; position: relative; text-align: @if(\App::getLocale() == 'ar') left @else right @endif; ">
    <a type="button" class="btn btn-primary"  href="{{route('admin.banks.create')}}">@lang('Create new bank')</a>
</div>
                        ...
                        <tbody>
                            @foreach ($lists as $list)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.banks.edit',$list->id) }}">
                                            {{ $list->bank_name ?? '' }}
                                        </a>
                                    </td>
                                    <td>
                                    ...
                                    <td style="display: inline-flex;">
                                        <a style="@if(\App::getLocale() == 'ar') margin-left: 5px; @else margin-right: 5px; @endif"
                                            ...
                                            href="{{ route('admin.banks.edit',$list->id) }}">
                                            <i class="bx bx-pencil"></i>
                                        </a>
                                        {!! action_table_delete(route('admin.banks.destroy',$list->id),$list->id) !!}                                        
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
