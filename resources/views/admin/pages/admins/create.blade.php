            ...
            <div class="card-body">
                <form action="{{ route('admin.admins.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingNameInput" name="first_name" placeholder="@lang('First Name')" value="{{ old('first_name') }}">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingNameInput" name="last_name" placeholder="@lang('Last Name')" value="{{ old('last_name') }}">
