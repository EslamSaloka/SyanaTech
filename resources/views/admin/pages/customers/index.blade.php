...
<!--    <a type="button" class="btn btn-primary"  href="{{route('admin.customers.create')}}">@lang('Create new customer')</a>-->
<!--</div>-->
                        ...
                        <tbody>
                            @foreach ($lists as $list)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.customers.edit',$list->id) }}">
                                            {{ $list->first_name ?? '' }}
                                        </a>
                                    </td>
                                    <td>
                                    ...
                                    <td style="display: inline-flex;">
                                        <a style="@if(\App::getLocale() == 'ar') margin-left: 5px; @else margin-right: 5px; @endif"
                                            ...
                                            href="{{ route('admin.customers.edit',$list->id) }}">
                                            <i class="bx bx-pencil"></i>
                                        </a>
                                        {!! action_table_delete(route('admin.customers.destroy',$list->id),$list->id) !!}                                        
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
...
<div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptionsFilter" aria-labelledby="offcanvasWithBothOptionsLabel">
    ...
    <div class="offcanvas-body">
        <form action="{{ route('admin.customers.index') }}" method="get" enctype="multipart/form-data">
            ...
            <div class="row" style=" margin-top: 20px; ">
                <div style="text-align: right">
                    <a href="{{ route('admin.customers.index') }}" style=" float: left; " class="btn btn-primary w-md">
                        @lang('Reset')
                    </a>
