            ...
            <div class="card-body">
                <form action="{{ route('admin.customers.update',$customer->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingNameInput" name="first_name" placeholder="@lang('First Name')" value="{{ old('first_name',$customer->first_name) }}">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingNameInput" name="last_name" placeholder="@lang('Last Name')" value="{{ old('last_name',$customer->last_name) }}">
                    ...
                    <div class="form-floating mb-3">
                        <input type="email" class="form-control" id="floatingEmailInput" name="email" placeholder="@lang('Email')" value="{{ old('email',$customer->email) }}">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingPhoneInput" name="phone" placeholder="@lang('Phone Number')" value="{{ old('phone',$customer->phone) }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-lg-1">
                            <img src="{{ display_image_by_model($customer,'avatar','first_name') }}" alt="" class="rounded-circle header-profile-user">
                        </div>
                    </div>
                    ...
                    <div class="form-floating mb-3">
                        <select name="how_to_know_us" class="form-select">
                            @foreach ($items as $item)
                                <option @if ($customer->how_to_know_us == $item->id)
                                    selected
