            ...
            <div class="card-body">
                <form action="{{ route('admin.profile.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingNameInput" name="first_name" placeholder="@lang('First Name')" value="{{ old('first_name',$user->first_name) }}">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingNameInput" name="last_name" placeholder="@lang('Last Name')" value="{{ old('last_name',$user->last_name) }}">
                    ...
                    <div class="form-floating mb-3">
                        <input type="email" class="form-control" id="floatingEmailInput" name="email" placeholder="@lang('Email')" value="{{ old('email',$user->email) }}">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingPhoneInput" name="phone" placeholder="@lang('Phone Number')" value="{{ old('phone',$user->phone) }}">
